...
import com.study.chat.constant.VoiceUrl;
import java.io.File;
...
public class VoiceCloneTools {
    ...
    public void audioClone(String content, String voiceName) {
        try {
            ...
            // 根据传入的音色匹配 url
            VoiceUrl voiceUrl = VoiceUrl.VOICE_URL_MAP.get(voiceName);
            if (voiceUrl == null) {
                log.error("音色不存在");
                return;
            }
            ...
            SpeechSynthesisParam param = SpeechSynthesisParam.builder()
                ...
                .build();
            SpeechSynthesizer synthesizer = new SpeechSynthesizer(param, null);  // 非流式第二个参数设置为空
            ...
            // 4. 保存语音文件
            File file = new File("19-AudioClone/src/main/resources/audios/output/result.mp3");
            if (!file.exists()) {
