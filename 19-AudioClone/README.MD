...
3. 获取音色文件的URL：http://blogmedia.463644535.xyz/Guodegang.mp3
...
测试路由：<br/>
http://localhost:8080/ai/qwen/voice/clone?content=我是hartli，是一个天天搬砖的程序猿&voiceName=guodegang

运行结果不报错，看到音频文件生成在 `src/main/resources/audios/output/result.mp3` 文件中。
![运行结果](materials/result.png)
