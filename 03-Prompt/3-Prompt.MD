...
![开发者 prompt 视角](materials/dev-prompt.png)
...
测试路由：http://localhost:8080/ai/chat/deepseek/multi_roles?question=参考苹果 iPhone16 系列的营销，写一份突出独特卖点、能吸引消费者购买的荣耀40系列产品推广方案

测试结果：
![prompt-assistant-result.png](materials/prompt-assistant-result.png)
