...
![SpringAI支持ASR的大模型](materials/spring-ai-supported-asr-models.png)
...
![千问ASR介绍](materials/qwen-asr-desc.png)
...
public class AudioDetectionController {
    ...
    public String getAudio() {
        String filePath = "file://ABSOLUTE_PATH/test.mp3";  // ABSOLUTE_PATH：文件的绝对路径
...
测试结果：
![第二次测试结果](materials/asr-result-2.png)
