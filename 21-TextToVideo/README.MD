...
![SpringAI支持的模型列表](materials/spring-ai-supported-models.png)
...
测试结果：
![result-1](materials/result-1.png)


http://localhost:8080/ai/zhipu/video/result/{id}

测试结果：
![result-2](materials/result-2.png)

可以看到目前图片的状态是 PROCESSING，表示正在处理中。当出现如下图示时，表示处理完成：

![result-3](materials/result-3.png)

生成的封面图：
![1764593523827_watermark.png](materials/result/1764593523827_watermark.png)

生成的视频：

[1764593523635_watermark.mp4](materials/result/1764593523635_watermark.mp4)
