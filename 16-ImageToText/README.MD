...
![free-models.png](materials/free-models.png)

PS: 本次视觉理解的前置知识点是 “Spring AI 集成智谱AI”，若不清楚的话可以参考 [12-multi-model](../12-MultiModel/README.MD)。
...
```
* 测试1
  * 测试图片：[女生图片](materials/girl.png)
  * 测试路由：http://localhost:8080/ai/zhipu/image_detection?question=请分析图片中的内容
  * 测试结果：![女生图片解析结果](materials/girl-image-result.png)
   
* 测试2
  * 测试图片：[报告解析图片](materials/report.png)
  * 测试路由：http://localhost:8080/ai/zhipu/image_detection?question=帮我解读一下图片报告
  * 测试结果：![报告解析结果](materials/report-image-result.png)
* 测试3
  * 测试图片：[文字提取图片](materials/text.png)
  * 测试路由：http://localhost:8080/ai/zhipu/image_detection?question=帮我提取图片中的文字
  * 测试结果：![文字提取结果](materials/text-image-result.png)
