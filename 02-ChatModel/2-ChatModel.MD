...
完整的提示词示例：
![ChatModel API](materials/chat-model-pic.png)
...
```
此时得到的结果就是正确的了。
![流式正确结果](materials/stream-chat-correct-result.png)
...
测试结果：
![ChatClient 测试结果](materials/chat-client-result.png)
