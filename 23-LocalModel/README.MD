...
![安装 curl 命令](materials/install_curl.png)
...
![安装 Ollama](materials/install_ollama.png)

#### 1.3 运行模型

Ollama [支持的模型](https://ollama.com/search)很多，本次选择国产模型 `GLM-4-9B` (智谱AI推出的模型)。

![搜索模型](materials/search-model.png)
...
![创建模型存放目录](materials/create-new-model-save-folder.png)

![给目录添加权限](materials/grant-permissions.png)

![加载重启ollama相关命令](materials/reload-restart-ollama.png)

![修改服务配置](materials/edit-ollama-config.png)
...
![ollama-run](materials/ollama-run.png)

![deepseek-r1-run](materials/deepseek-r1-run.png)

![ollama列表以及删除功能](materials/ollama-list-del.png)
...
测试结果：<br/>
![测试结果](materials/ollama-result.png)