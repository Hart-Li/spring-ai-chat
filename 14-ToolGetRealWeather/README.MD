...
1. 注册账号（省略）
2. 实名认证（省略）
3. 创建应用 ![new_app](materials/gaode_add_app.png)
4. 添加 Key![new_key](materials/gaode_add_key.png)
![add_key_result](materials/daode_add_key_result.png)
...
测试路由：<br/>
http://localhost:8080/ai/chat/deepseek?question=今天北京的天气怎么样？

![测试结果](materials/test-result.png)