...
![基于内存的多轮会话流程图](materials/chat-memory-base-flow-chart.png)
...
1. http://localhost:8080/ai/chat/deepseek/global_advisor?question=我是HartLi，是一名Java架构师，知识分享者，请记住我，以便我们后面的对话&conversationId=2
2. http://localhost:8080/ai/chat/deepseek/global_advisor?question=我是谁&conversationId=2
